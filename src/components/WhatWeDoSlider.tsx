      ...
      >
        {serviceData.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="bg-[#FFF0D1] h-max text-black rounded-lg px-6 py-8 flex flex-col gap-x-6 sm:gap-x-0 group cursor-pointer hover:bg-[#e2d5ba] transition-all duration-300">
              {/* Purple line */}
              ...
              {/* Title & Description */}
              <div className="mb-8">
                <div className="mb-2 text-lg text-black font-bold">{item.title}</div>
              ...
              <div className="text-3xl">
                <RxArrowTopRight className="text-black hover:text-[#4A4947] group-hover:rotate-45 group-hover:text-accent transition-all duration-300" />
              </div>
            </div>
          </SwiperSlide>
        ))}
