...
function Footer() {
  return (
    <footer className=" text-gray-400 py-12 min-h-screen flex flex-col justify-center">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4 sm:px-6 lg:px-8">
        ...
        <div>
          ...
          <ul>
            <li className="py-2">
              <Link href="#" className="hover:text-white transition-colors bg-purple-400 py-[2px] text-black font-extrabold duration-300 pr-40 pl-2">
                Home
              </Link>
            </li>
            <li className="py-2">
            ...
            <li className="py-2">
              <Link href="/contact" className="hover:text-white transition-colors bg-purple-400 py-[2px] text-black font-extrabold duration-300 pr-[147px] pl-2">
                Contact
              </Link>
            </li>
          </ul>
