...
export function BackgroundLinesDemo() {
  ...
  return (
    <BackgroundLines className="flex items-center justify-center w-full h-screen flex-col md:flex-row px-6 md:px-14]">
      ...
      >
        <h2 className="bg-clip-text text-[#FFF0D1] text-2xl md:text-4xl lg:text-6xl font-sans py-4 md:py-8 relative z-20 font-bold tracking-tight">
          Welcome to <br />
          <span className="text-purple-400">NAIYO24 PRIVATE LIMITED</span>
        </h2>
      </motion.div>
