...
export function BackgroundLinesDemo() {
  ...
  return (
    <BackgroundLines className="flex items-center justify-center w-full flex-col md:flex-row px-14">
      ...
      >
        <h2 className="bg-clip-text text-transparent text-left bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
          Welcome to <br /> <span className="text-purple-400">NAIYO24 PRIVATE LIMITED</span>
        </h2>
      </motion.div>
